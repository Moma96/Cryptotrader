                        ...
                        <div class="deposit-container white-background">
                            <div class="deposit-fields-row">
                                ...
                                <div class="currency-switch-box-first">
                                    ...
                                    <div id="currency-search-first" class="currency-search-1">
                                        <form method="post" action="<?php echo base_url(); ?>transfering/withdraw">
                            ...
                            <div class="deposit-fields-row">
                                <form method="post" action="<?php echo base_url(); ?>transfering/withdraw">
                                    ...
                                    <span class="withdraw-available-label">Available: </span>
                                    <span class="withdraw-available-amount"><?php echo $userdata['available']; ?></span>
